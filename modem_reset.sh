...
# modem
modemip=<address of your copperjet> # default: 172.19.3.1
modemname=<name of your copperjet>
modemuser=admin
modempass=admin # default password for Alice/BBned: bb@l1cE322
...
zipb_configure() {
	(	sleep 1
		...
		sleep 1 ; echo -e "zipb set lan leasetime 3600\r"
		sleep 1 ; echo -e "zipb set lan mask 0.0.0.0\r"
		sleep 1 ; echo -e "zipb set lan powerdowntime 3600\r"
